	...
	else if	((InRect(MousePosition.x,MousePosition.y,Bmp[INVPAPIER].rcDes)) && (HauptMenue === MEINVENTAR))
	{
		for (let i=ROHAST; i<=ROHSCHLEUDER; i++) {
			if	(InRect(MousePosition.x,MousePosition.y,Bmp[i].rcDes) && (Guy.Inventar[i]>0))
			{
				...
				switch(i)
				{
				case ROHAST: DrawText(messages.AST,TXTTEXTFELD,2); break;
				case ROHSTEIN: DrawText(messages.STEIN,TXTTEXTFELD,2); break;
				case ROHAXT: DrawText(messages.AXT,TXTTEXTFELD,2); break;
				case ROHBLATT: DrawText(messages.BLATT,TXTTEXTFELD,2); break;
				case ROHSTAMM: DrawText(messages.STAMM,TXTTEXTFELD,2); break;
				case ROHEGGE: DrawText(messages.EGGE,TXTTEXTFELD,2); break;
				case ROHLIANE: DrawText(messages.LIANE,TXTTEXTFELD,2); break;
				case ROHANGEL: DrawText(messages.ANGEL,TXTTEXTFELD,2); break;
				case ROHHAMMER: DrawText(messages.HAMMER,TXTTEXTFELD,2); break;
				case ROHFERNROHR: DrawText(messages.FERNROHR,TXTTEXTFELD,2); break;
				case ROHSTREICHHOLZ: DrawText(messages.STREICHHOLZ,TXTTEXTFELD,2); break;
				case ROHSCHAUFEL: DrawText(messages.SCHAUFEL,TXTTEXTFELD,2); break;
				case ROHKARTE: DrawText(messages.KARTE,TXTTEXTFELD,2); break;
				case ROHSCHLEUDER: DrawText(messages.SCHLEUDER,TXTTEXTFELD,2); break;
				}
